...
<footer class="p-4 mt-40 bg-white rounded shadow md:flex md:items-center md:justify-between sm:p-5 dark:bg-gray-800">
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" class="hover:underline" target="_blank">Filip Tashkoski™</a>. All Rights Reserved.
    </span>
